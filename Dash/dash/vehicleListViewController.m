...
-(void)connectionDidFinishLoading:(NSURLConnection *)connection
{
    ...
    for (int i = 0; i < [vehicleInfoArray count]; i++) {
        ...
        NSString *insert = [NSString stringWithFormat:@"INSERT INTO vehiclesList (vehicleId, vehicleColor, vehicleNumber, vehicleMake,vehicleModal,vehicleImageUrl) VALUES (\"%@\", \"%@\", \"%@\", \"%@\",\"%@\",\"%@\")",vehicleIDs,vehicleColor,vehicleNumber,vehicleMake,vehicleModal,strEncoded];
