...
- (void)viewDidLoad {
    ...
    if ([self.addLocationDataType isEqualToString:@"Edit"])
    {
        ...
        camera = [GMSCameraPosition cameraWithLatitude:30.733314800000000000
    ...
    if ([self.addLocationDataType isEqualToString:@"Edit"]) {
        ...
        marker.position = CLLocationCoordinate2DMake(30.733314800000000000, 76.779417900000000000);
    }
